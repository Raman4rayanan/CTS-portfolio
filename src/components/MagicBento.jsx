      ...
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            .card-responsive .card:nth-child(7) { grid-column: span 2; grid-row: span 1; }
            .card-responsive .card:nth-child(9) { grid-column: 1 / -1; grid-row: span 1; }
          }
              ...
              >
                ...
                {card.image && (
                  <>
                    ...
                    <div className="absolute inset-0 z-0 bg-gradient-to-t from-primary-navy/90 via-primary-navy/40 to-black/20" />
                  </>
                )}
                  ...
                  <div className="card__header flex flex-col sm:flex-row justify-between items-start gap-4 mb-4">
                    ...
                    {!card.image && (
                      <div className="w-16 h-16 bg-blue-50/50 rounded-2xl flex items-center justify-center border border-blue-100/50 relative overflow-hidden group shrink-0">
                        ...
                        {Icon ? (
                          <Icon size={32} className="text-primary-blue relative z-10" strokeWidth={1.5} />
                        ) : (
                          <div className="text-primary-blue/50 text-xs text-center font-bold relative z-10">Icon<br/>Slot</div>
                        )}
                      </div>
                    )}
